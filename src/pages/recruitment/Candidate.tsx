    ...
    <>
      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-green-400 text-white p-4 rounded-lg shadow">
            <h2 className="text-xl font-bold">2</h2>
            <p>Today Working</p>
          </div>
          <div className="bg-orange-400 text-white p-4 rounded-lg shadow">
                        ...
                        <div className="p-4 space-y-6">
                          ...
                          <div className="mt-6">
                            <div className="grid grid-cols-2 gap-4 mb-2">
                              <div>
                                <label className="block mb-1">
                                  Do you intent to study further?
                                </label>
                                <div className="flex gap-4">
                                  <label>
                                    <input type="radio" name="studyFurther" />{" "}
                                    Yes
                                  </label>
                                  <label>
                                    <input type="radio" name="studyFurther" />{" "}
                          ...
                          <table className="w-full border-collapse border border-gray-300 mt-4">
                            ...
                            <tbody>
                              <tr>
                                <td className="border p-2">
                                  ACBC Logistics Pte Ltd Singapore
                                </td>
                          ...
                          <table className="table-auto w-full border border-gray-300 mb-6">
                            ...
                            <tbody>
                              {[
                                {
                                  id: "main",
                                  text: "Do you have any medical problem or physical disability?",
                                },
                                {
                                  id: "a",
                                  text: "Skin, ears, nose, throat, eye - e.g. hearing problems, otitis media, sinusitis, cataract, night blindness, blurred vision?",
                                },
                                {
                                  id: "b1",
                                  text: "Stomach, intestines, liver, gall bladder, pancreas - e.g. diabetes, piles, hernia, cirrhosis?",
                                },
                                {
                                  id: "c",
                                  text: "Lungs, bones, joints - e.g. asthma, bronchitis, slipped disc, fractures, muscular dystrophy?",
                                },
                                {
                                  id: "d",
                                  text: "Heart, brain, mental or nervous disorder - e.g. low/high BP, stroke, fits, migraine, depression?",
                                },
                                {
                                  id: "e",
                                  text: "Lymphatic system - e.g. gout, thyroid?",
                                },
                                {
                                  id: "f",
                                  text: "Cancer, tumor, growth of any kind?",
                                },
                              ].map((item) => (
                                <tr
                                  key={item.id}
                            ...
                            <tbody>
                              <tr className="border-t border-gray-300">
                                <td className="p-2 align-top">
                                  2) Do you have any implants - for example:
                                  pacemaker, stent or implant?
                                </td>
                                <td className="p-2 text-center">
                                  <div className="flex justify-center gap-6">
                                    <label className="flex items-center gap-2">
